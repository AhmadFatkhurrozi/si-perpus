	...
	function __css($css){
		...
		switch ($css) {
			...
			case 'popup':
				...
				break;
			case 'theme':
				$src = base_url().'dist/css/theme.css';
				break;
			case 'template':
				$src = base_url().'dist/css/template.css';
				break;
			case 'fontastic':
				$src = base_url().'dist/css/fontastic.css';
				break;
			case 'custom':
				$src = base_url().'dist/css/custom.css';
				break;
			case 'default':
				$src = base_url().'dist/css/default.css';
				break;
			default:
				break;
